...
model Nordic44_Original_Case
  ...
  OpenIPSL.Electrical.Buses.BusExt bus_5620(
    ...
    V_b=300)
    annotation (Placement(visible = true, transformation(extent = {{280, -104}, {282, -84}}, rotation = 0)));
...
equation
  ...
  connect(bus_5620.p[1], line_5600_5620.n) annotation(
    Line(points = {{282, -94}, {288, -94}, {288, -75.5}}, color = {0, 0, 255}));
  ...
  connect(Load_bus5620.p, bus_5620.n[1]) annotation(
    Line(points = {{269.5, -94.75}, {271.9, -94.75}, {271.9, -94}, {280, -94}}, color = {0, 0, 255}));
